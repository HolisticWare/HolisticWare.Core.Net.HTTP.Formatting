...
{
    public class MediaTypeFormatterThriftJSON : MediaTypeFormatter
    {
        private const string MimeType = "application/vnd.apache.thrift.json";

        public MediaTypeFormatterThriftJSON()
        {
            SupportedMediaTypes.Add(new MediaTypeHeaderValue(MediaTypeFormatterThriftJSON.MimeType));
            MediaTypeMappings.Add
                (
                    new RequestHeaderMapping
                            (
                                "Accept",
                                MediaTypeFormatterThriftJSON.MimeType,

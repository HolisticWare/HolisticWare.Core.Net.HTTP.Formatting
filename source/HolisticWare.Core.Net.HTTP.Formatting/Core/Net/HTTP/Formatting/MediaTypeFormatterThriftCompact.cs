...
{
    public class MediaTypeFormatterThriftCompact : MediaTypeFormatter
    {
        private const string MimeType = "application/vnd.apache.thrift.compact";

        public MediaTypeFormatterThriftCompact()
        {
            SupportedMediaTypes.Add(new MediaTypeHeaderValue(MediaTypeFormatterThriftCompact.MimeType));
            MediaTypeMappings.Add
                (
                    new RequestHeaderMapping
                            (
                                "Accept",
                                MediaTypeFormatterThriftCompact.MimeType,
